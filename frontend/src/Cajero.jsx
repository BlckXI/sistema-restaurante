...
{/* ORDEN (COLUMNA DERECHA) - SOLUCIÓN DEFINITIVA */}
<div className="w-full md:w-1/3 flex flex-col h-full">
<div className="bg-gray-50 p-4 rounded shadow border border-gray-200 flex flex-col flex-1 min-h-0">
  ...
  {/* CARRITO - VERSIÓN CON ALTURA FIJA QUE NUNCA FALLA */}

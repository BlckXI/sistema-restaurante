...
const [comentarios, setComentarios] = useState(''); // NUEVO ESTADO
...
<div className="w-full md:w-1/3 bg-gray-50 p-4 rounded shadow border border-gray-200 flex flex-col justify-between h-full">
...
<button onClick={procesarOrden} disabled={enviando}
  className={`w-full font-bold py-4 rounded-lg text-lg 
  ${enviando ? 'bg-gray-400' : esPersonal ? 'bg-red-600 hover:bg-red-700' : 'bg-green-600 hover:bg-green-700'} 

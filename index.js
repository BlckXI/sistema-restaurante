    ...
    if(ordenes) {
        ordenes.forEach(o => {
            if (o.estado === 'anulado') {
                ...
                // --- CAMBIO: Excluir consumo personal de la suma de dinero ---
        ...
        if(datos.ordenes) {
            datos.ordenes.forEach(o => {
                if (o.estado !== 'anulado') {
                    ...
                    // Aquí solo sumamos al desglose visual, pero la variable 'datos.ventas'
                    // que va al frontend ya viene protegida por calcularFinanzasDia
